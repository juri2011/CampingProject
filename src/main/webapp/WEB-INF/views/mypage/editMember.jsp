		...
		<div class="joinBox">
			...
			<table class="table_row W100P MAT10">
				...
				<tr>
					...
					<td>
						<input type="text" name="mem_id" size="20" maxlength="16" readonly /><!-- readonly속성추가 -->
				...
				<tr>
					...
					<td><input type="password" name="pwd" size="20" maxlength="16" readonly/><!-- readonly속성추가 -->
						<span class="f12 fC666">※ 8~16글자의 영어, 숫자 혼용</span>
					</td>
				</tr>
				<tr>
					<th><span class="blet">*</span> 비밀번호 확인</th>
					<td><input type="password" name="pwd2" size="20" maxlength="16" readonly/></td>
				</tr>
				<tr>
			...
			<div class="btnZone">
				<input type="button" id="btn" class="btn" onClick="join();" value="수정"/><!-- 버튼이름변경. -->
