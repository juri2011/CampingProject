      ...
      <div class="container">
        <div class="menu-bg-wrap">
          <div class="site-navigation">
            <a href="test.html" class="logo m-0 float-start">CampingGa</a>
          ...
          <div class="col-12">
            <div class="property-slider-wrap">
              <div class="property-slider">
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="${pageContext.request.contextPath}/resources/images/img_6.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="${pageContext.request.contextPath}/resources/images/img_7.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="${pageContext.request.contextPath}/resources/images/img_8.jpg" alt="Image" class="img-fluid" />
                  </a>
          ...
          <div class="testimonial-slider">
            <div class="item">
              <div class="testimonial">
                <img
                  src="${pageContext.request.contextPath}/resources/images/person_1-min.jpg"
                  alt="Image"
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="${pageContext.request.contextPath}/resources/images/person_3-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="${pageContext.request.contextPath}/resources/images/person_4-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
        ...
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
            <div class="img-about dots">
              <img src="${pageContext.request.contextPath}/resources/images/hero_bg_3.jpg" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
